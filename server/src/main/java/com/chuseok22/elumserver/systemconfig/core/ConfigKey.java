...
public enum ConfigKey {
  ...
  MEMBER_WITHDRAWN_RETENTION_DAYS(
    ...
    "탈퇴 뒤 계정 식별값과 AI 이용 기록을 남겨 두는 기간. 이 안에 같은 소셜 계정으로 오면 이전 계정을 빈 상태로 되살려 사용량을 잇고, 지나면 완전히 지운다. ⚠️ 개인정보처리방침 4조의 보관 기간(1년 = 365)과 같아야 한다 — 바꾸려면 방침을 먼저 개정하고 시행 7일 전에 알린다. 1~3650",
