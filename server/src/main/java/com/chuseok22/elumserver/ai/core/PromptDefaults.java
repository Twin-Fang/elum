...
public final class PromptDefaults {
  ...
  public static final Map<PromptKey, String> DEFAULTS = Map.of(
    ...
    PromptKey.GEMINI_ROUTINE_QUESTION_PREFIX, """
      ...
      도움 방식에 맞춰, 이 일과를 준비하는 데 필요한 준비물이나 평소와 달라지는 상황을 보호자에게 \
      확인하기 위한 질문 하나와 선택지 3~5개를 만드세요. 질문은 짧고 구체적이어야 하며, 선택지는 \
      실제 준비물/상황 예시여야 합니다. 반드시 제공된 JSON Schema 형식으로만 응답하세요."""
  );
